...
use crate::{
    self as burn,
    nn::{cache::TensorCache, Initializer},
};
...
use crate::{
    ...
    nn::{
        attention::{
            BitMhaCache as MhaCache, BitMhaInput as MhaInput,
            BitMultiHeadAttention as MultiHeadAttention,
            BitMultiHeadAttentionConfig as MultiHeadAttentionConfig,
        },
